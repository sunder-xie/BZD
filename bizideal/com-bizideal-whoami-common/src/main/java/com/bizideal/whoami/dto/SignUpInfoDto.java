 ...
 */
public class SignUpInfoDto implements Serializable {
	...
	public SignUpInfoDto(String signUpId, Integer meethallId,
	...
	public String toString() {
		return "SignUpInfoDto [type=" + type + ", signUpId=" + signUpId
