 ...
 */
@Table(name = "meeting_hall")
public class MeetingHall extends BaseOpEntity {
	...
	public MeetingHall(Integer hallId, String hallName, String hallIntro, String hallCover, String hallBackImage,
	...
	public String toString() {
		return "MeetingHall [hallId=" + hallId + ", hallName=" + hallName
				...
				+ hallVisits + ", hallVipType=" + hallVipType + "]";
	}
